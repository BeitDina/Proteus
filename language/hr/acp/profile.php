...
'HIDE_PROFILE_FIELD_EXPLAIN'=>'Ako je omogućeno, korisničko polje bit će prikazano samo korisniku/ci te administratori(ca)ma/moderatori(ca)ma.<br />Ako je onemogućen prikaz u korisničkom Profilu/Postavkama, korisnik/ca neće moći vidjeti/uređivati polje (a) što će moći [samo] administratori(ce)/moderatori(ce).',
