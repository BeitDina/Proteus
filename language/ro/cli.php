...
$lang = array_merge($lang, array(
	...
	'CLI_DESCRIPTION_EXTENSION_MANAGE'					=> 'en Manages an extension',
	'CLI_DESCRIPTION_EXTENSION_MANAGE_ARGUMENT'			=> 'en Extension to manage',
	'CLI_DESCRIPTION_EXTENSION_INSTALL'					=> 'en Install the specified extension(s).',
	'CLI_DESCRIPTION_EXTENSION_INSTALL_OPTION_ENABLE'	=> 'en Enable extension(s) after installation',
	'CLI_DESCRIPTION_EXTENSION_INSTALL_ARGUMENT'		=> 'en Extension(s) to install, e.g.: vendor/package',
	'CLI_DESCRIPTION_EXTENSION_LIST_AVAILABLE'			=> 'en List extensions available for installation.',
	'CLI_DESCRIPTION_EXTENSION_REMOVE'					=> 'en Remove the specified extension(s).',
	'CLI_DESCRIPTION_EXTENSION_REMOVE_OPTION_PURGE'		=> 'en Purge extension(s) when removing them',
	'CLI_DESCRIPTION_EXTENSION_REMOVE_ARGUMENT'			=> 'en Extension(s) to remove, e.g.: vendor/package',
	'CLI_DESCRIPTION_EXTENSION_UPDATE'					=> 'en Update the specified extension(s).',
	'CLI_DESCRIPTION_EXTENSION_UPDATE_ARGUMENT'			=> 'en Extension(s) to update, e.g.: vendor/package',
));
