...
$lang = array_merge($lang, array(
	...
	'DISPLAY_UNAPPROVED_POSTS'		=> 'en Display unapproved posts to the author',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'en Unapproved posts can be viewed by the author. Does not apply to Guest posts.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'en Allow board notifications',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'				=> 'en Allowed schemes in links',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'en Users can only post schemeless URLs or one of the comma-separated list of allowed schemes.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Această pagină permite utilizatorilor să trimită email-uri către administratorii forumului',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'				=> 'Dacă această setare este activată, unele fișiere vor fi furnizate de servere externe în locul serverului dumneavoastră. Aceasta va reduce traficul pe server, dar poate fi o problemă de confidențialitate pentru unii administratori de forum. În instalarea standard a phpBB, se include încărcarea “jQuery” și fontul “Open Sans” furnizat de Google.',
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> 'en User’s activity post limit',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'en The active topic/forum won’t be shown for users having more than this number of posts. Set to 0 to disable the limit.',
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'en Enable permission specific PM button in topic pages',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> 'en If this setting is enabled, only post profiles of users who are permitted to read private messages will have a private message button.',
...
$lang = array_merge($lang, array(
	...
	'UPLOAD_CERT_VALID'				=> 'en Validate upload certificate',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'en If enabled, certificates of remote uploads will be validated. This requires the CA bundle to be defined by the <samp>openssl.cafile</samp> or <samp>curl.cainfo</samp> setting in your php.ini.',
));
...
$lang = array_merge($lang, array(
	...
	'EMAIL_FORCE_SENDER'			=> 'en Force from email address',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'en This will set the <samp>Return-Path</samp> to the from email address instead of using the local user and hostname of the server. This setting does not apply when using SMTP.<br><em><strong>Warning:</strong> Requires the user that the webserver runs as to be added as trusted user to the sendmail configuration.</em>',
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> 'en Maximum allowed email recipients',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'en If necessary, set this to not exceed the maximum number of recipients that your email server will allow in one email message.',
	...
	'SEND_TEST_EMAIL'				=> 'en Send a test email',
	'SEND_TEST_EMAIL_EXPLAIN'		=> 'en This will send a test email to the address defined in your account.',
	'SMTP_ALLOW_SELF_SIGNED'		=> 'en Allow self-signed SSL certificates',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'en Allow connections to SMTP server with self-signed SSL certificate. <br><em><strong>Warning:</strong> Allowing self-signed SSL certificates may cause security implications.</em>',
	'SMTP_AUTH_METHOD'				=> 'en Authentication method for SMTP',
	'SMTP_AUTH_METHOD_EXPLAIN'		=> 'en Only used if a username/password is set, ask your provider if you are unsure which method to use.',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Reţineţi că trebuie să menţionaţi protocolul utilizat de serverul dvs. Dacă folosiţi SSL, acesta trebuie să fie "ssl://your.mailserver.com"',
	...
	'SMTP_VERIFY_PEER'				=> 'en Verify SSL certificate',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'en Require verification of SSL certificate used by SMTP server. <br><em><strong>Warning:</strong> Connecting peers with unverified SSL certificates may cause security implications.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'en Verify SMTP peer name',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'en Require verification of peer name for SMTP servers using SSL / TLS connections. <br><em><strong>Warning:</strong> Connecting to unverified peers may cause security implications.</em>',
	'TEST_EMAIL_SENT'				=> 'en The test email has been sent.<br>If you don’t receive it, please check your emails configuration.<br><br>If you require assistance, please visit the <a href="https://www.phpbb.com/community/">phpBB support forums</a>.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED'			=> 'en Allow self-signed SSL certificates',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'en Allow connections to Jabber server with self-signed SSL certificate. <br><em><strong>Warning:</strong> Allowing self-signed SSL certificates may cause security implications.</em>',
	...
	'JAB_VERIFY_PEER'				=> 'en Verify SSL certificate',
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'en Require verification of SSL certificate used by Jabber server. <br><em><strong>Warning:</strong> Connecting peers with unverified SSL certificates may cause security implications.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'en Verify Jabber peer name',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'en Require verification of peer name for Jabber servers using SSL / TLS connections. <br><em><strong>Warning:</strong> Connecting to unverified peers may cause security implications.</em>',
));
