...
$lang = array_merge($lang, array(
    'ADDED_PROFILE_FIELD'   => 'Câmp profil particularizat adăugat.',
    'ALPHA_DOTS'			=> 'Alfanumeric și puncte (perioadele)',
	'ALPHA_ONLY'            => 'Numai alfanumeric',
    'ALPHA_SPACERS'         => 'Alfanumeric şi spaţii',
   	'ALPHA_UNDERSCORE'		=> 'Alfanumeric și liniuță de subliniere',
	'ALPHA_PUNCTUATION'		=> 'Alfanumeric cu virgulă, puncte, liniuță de subliniere și cratime, prima trebuie să fie o literă',
    ...
    'DISPLAY_AT_PROFILE'            => 'Afişează în panoul de control al utilizatorului',
    ...
    'DISPLAY_ON_MEMBERLIST'			=> 'Afişează în lista membrilor',
	'DISPLAY_ON_MEMBERLIST_EXPLAIN'	=> 'Dacă această opțiune este activată, câmpul va fi afișat în dreptul utilizatorului în ecranul cu lista membrilor.',
	'DISPLAY_ON_PM'					=> 'Afişează în ecranul de vizualizare mesaje private',
	'DISPLAY_ON_PM_EXPLAIN'			=> 'Dacă această opțiune este activată, câmpul va fi afișat în mini-profilul din ecranul de vizualizare a mesajelor private.',
    ...
    'FIELD_CONTACT_DESC'		=> 'Descriere contact',
	'FIELD_CONTACT_URL'			=> 'Legătură contact (link)',
	'FIELD_DATE'                => 'Dată',
    ...
    'FIELD_INT'                 => 'Numere',
    'FIELD_IS_CONTACT'			=> 'Afișează câmpul drept un câmp de contact',
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'Câmpurile de contact sunt afișate în secțiunea de contact a profilului de utilizator și sunt afișate diferit în mini profilul de lângă mesaje si mesaje private. Puteți folosi <samp>%s</samp> ca o variabilă ce va fi înlocuită cu valoarea furnizată de utilizator.',
    ...
    'LETTER_NUM_DOTS'			=> 'Litere, numere și puncte (perioade)',
	'LETTER_NUM_ONLY'			=> 'Litere și numere',
	'LETTER_NUM_PUNCTUATION'	=> 'Litere, numere, virgule, puncte, liniuțe de subliniere și liniuțe, trebuie să înceapă cu o literă',
	'LETTER_NUM_SPACERS'		=> 'Litere, numere și spații',
	'LETTER_NUM_UNDERSCORE'		=> 'Litere, numere și liniuțe de subliniere',
