...
$lang = array_merge($lang, array(
    'AUTO_PRUNE_DAYS'            => 'Ștergere automată mesaje vechi',
    'AUTO_PRUNE_DAYS_EXPLAIN'    => 'Numărul de zile de la ultimul mesaj după care subiectul este mutat.',
    'AUTO_PRUNE_FREQ'            => 'Frecvenţa ştergerii automate',
    'AUTO_PRUNE_FREQ_EXPLAIN'    => 'Timpul în zile între ştergerile automate.',
    'AUTO_PRUNE_VIEWED'          => 'Ștergere automată a mesajelor în funcţie de vechimea vizualizării',
    'AUTO_PRUNE_VIEWED_EXPLAIN'  => 'Numărul de zile de când subiectul a fost vizualizat după care subiectul este mutat.',
   	'AUTO_PRUNE_SHADOW_FREQ'	 => 'Ștergere automată umbre frecvență subiecte',
	'AUTO_PRUNE_SHADOW_DAYS'	 => 'Ștergere automată umbre subiecte în funcţie de vechimea vizualizării',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'Numărul de zile după care umbrele subiectelor vor fi șterse.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'Timpul în zile între ştergerile automate.',
	...
	'FORUM_NAME_EMOJI'					=> 'en The forum name you entered is invalid.<br>It contains the following unsupported characters:<br>%s',
    ...
    'FORUM_PRUNE_SHADOW'				=> 'Activare ștergere automată umbre subiecte',
	'FORUM_PRUNE_SHADOW_EXPLAIN'		=> 'Setați mai jos frecvența/perioada ștergerii automate a umbrelor de subiecte din forum.',
    ...
    'LINK'						=> 'Legătură',
	'LIMIT_SUBFORUMS'			=> 'en Limit legend to direct child-subforums',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'en Limits the subforums to be displayed to subforums that are direct descendants (children) of the current forum. Disabling this will display all subforums with the “List subforums in legend” option enabled, regardless of depth.',
