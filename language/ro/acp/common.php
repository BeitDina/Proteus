...
$lang = array_merge($lang, array(
	...
	'ACP_EXTENSIONS_CATALOG'	=> 'Catalog Extensii',
	'ACP_EXTENSIONS_INSTALL'	=> 'Instalează extensii',
	'ACP_EXTENSIONS_REMOVE'		=> 'Înlătură extensii',
	'ACP_EXTENSIONS_UPDATE'		=> 'Actualizează extensii',
	'ACP_EXTENSIONS_MANAGE'		=> 'Rezolvă extensii automatic',
	...
	'ACP_HELP_PHPBB'			=> 'Ajută sususţine phpBB',
	...
	'ACP_STORAGE_SETTINGS'		=> 'Setări Stocare',
	...
	'CONTAINER_EXCEPTION' => 'en phpBB encountered an error building the container due to an installed extension. For this reason, all extensions have been temporarily disabled. Please try purging your forum cache. All extensions will automatically be re-enabled once the container error is resolved. If this error continues, please visit <a href="https://www.phpbb.com/support">phpBB.com</a> for support.',
	'EXCEPTION' => 'Excepţie',

	'COLOUR_SWATCH'			=> 'Mostră culoare web-safe',

	'COMPOSER_UNSUPPORTED_OPERATION'	=> 'en Operation unsupported for the package type “%s”.',
	'COMPOSER_UPDATING_DEPENDENCIES'	=> 'en Updating packages',
	'COMPOSER_LOADING_REPOSITORIES'		=> 'en Loading remote repositories with package information',
	'COMPOSER_ERROR_CONFLICT'			=> 'en Your requirements could not be resolved to an installable set of packages.',
	'COMPOSER_REPOSITORY_UNAVAILABLE'	=> 'en An error occurred while fetching the repository %s.',
	'COMPOSER_INSTALLING_PACKAGE'		=> '  - Installing %1$s (%2$s)',
	'COMPOSER_DELETING'					=> '  - Deleting %s',
	'COMPOSER_UPDATE_NOTHING'			=> 'en Nothing to update',
	'COMPOSER_OUTPUT'					=> 'en Composer output',
	...
	'LATEST_VERSION'		=> 'en Latest version',
	...
	'REMIND'							=> 'Reaminteşte',
	'REPARSE_LOCK_ERROR'				=> 'en Reparsing is already in progress by another process.',
	...
	'URL_INVALID'			=> 'en The provided URL for the setting “%1$s” is invalid.',
	'USERNAMES_EXPLAIN'		=> 'Introduceţi fiecare nume de utilizator pe linii separate.',
	'USER_CONTROL_PANEL'	=> 'Panoul utilizatorului',

	'UPDATE_NEEDED'			=> 'en The board is not up to date.',
	'UPDATE_NOT_NEEDED'		=> 'en The board is up to date.',
	'UPDATES_AVAILABLE'		=> 'en Updates available:',
...
$lang = array_merge($lang, array(
	...
	'VERSION_CHECK'					=> 'Verifică Versiune',
	'VERSION_CHECK_EXPLAIN'			=> 'en Checks to see if your phpBB installation is up to date.',
	'VERSIONCHECK_INVALID_ENTRY'	=> 'en Latest version information contains an unsupported entry.',
	'VERSIONCHECK_INVALID_URL'		=> 'en Latest version information contains invalid URL.',
	'VERSIONCHECK_INVALID_VERSION'	=> 'en Latest version information contains an invalid version.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'en Your phpBB installation is not up to date.<br />Below is a link to the release announcement, which contains more information as well as instructions on updating.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'en Your phpBB installation is not up to date.',
	'VERSION_UP_TO_DATE_ACP'		=> 'en Your phpBB installation is up to date. There are no updates available at this time.',
...
$lang = array_merge($lang, array(
	...
	'SEND_STATISTICS_LONG'		=> 'en Send statistical information',
	'SHOW_STATISTICS'			=> 'Arată detaliile',
	'THANKS_SEND_STATISTICS'	=> 'Vă mulţumim că aţi trimis informaţiile proprii.',
	'FAIL_SEND_STATISTICS'		=> 'en phpBB was unable to send statistics',
));
