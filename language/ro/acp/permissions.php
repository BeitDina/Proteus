...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		<p>Permisiunile sunt împărţite şi grupate în patru mari secţiuni, dupa cum urmează:</p>
		...
		<p>Sunt folosite pentru a crea seturi diferite de permisiuni pentru diferite tipuri de permisiuni, urmând ca mai târziu acestea să fie alocate pe baza rolurilor. Rolurile standard trebuie să acopere administrarea forumurilor mari şi mici, totuşi în interiorul fiecăruia dintre cele patru divizii puteţi adăuga/modifica/şterge rolurile aşa cum credeţi că e mai bine.</p>
		...
		<p>Pentru informaţii suplimentare legate de configurarea şi administrarea permisiunilor forumului phpBB3, vă rugăm să vizitaţi secțiunea <a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/permissions/">Setarea permisiuniilor din Ghidul rapid</a>.</p>
	',
