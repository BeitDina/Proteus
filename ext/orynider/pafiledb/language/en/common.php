...
Have fun!',
	...
	'ACP_NEW_SUB_CAT_EXPLAIN'			=> 'Enter here the folder name, which you like to use on your webspace for this category (without slashes!).<br />This folder will then be created automatically under your root/ext/orynider/pafiledb/files/ folder.<br />Allowed characters are a-z, A-Z, 0-9, the hyphen ( - ) and the underscore ( _ ) signs.',
