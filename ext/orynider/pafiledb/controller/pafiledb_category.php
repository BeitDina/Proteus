		...
		*/
		...
		else
		{
			...
			while ($row = $this->db->sql_fetchrow($result))
			{
				...
				{
					$download = '<img src="'. $board_url. 'ext/orynider/pafiledb/styles/prosilver/theme/images/' . 'files_no_download.png" title="' . sprintf($this->user->lang['FILES_NO_PERMISSION']) . '" alt=""></img>';
				}
				else
				{
					$download = '<a href="' . $this->helper->route('orynider_pafiledb_controller_download', array('file_id' =>	$dl_id)) . '"><img src="' . $board_url. 'ext/orynider/pafiledb/styles/prosilver/theme/images/' . 'icon_mini_dl.gif" title="' . $this->user->lang['FILES_REGULAR_DOWNLOAD'] . '" alt=""></a>';
				}
